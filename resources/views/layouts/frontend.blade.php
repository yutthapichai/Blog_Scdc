            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">Mon-Fri 8am-5pm</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <h6 href="#" class="title">{{ $settings->address}}</h6>
                            <p class="sub-title">HEAD OFFICE ADDRESS</p>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b6c6a262208cbb8"></script>
